...
you should place your code here."
  ...
  (define-key evil-normal-state-map (kbd "gh") (kbd "^")) ; H goes to beginning of the line
  (define-key evil-normal-state-map (kbd "gl") (kbd "$")) ; H goes to ending of the line
